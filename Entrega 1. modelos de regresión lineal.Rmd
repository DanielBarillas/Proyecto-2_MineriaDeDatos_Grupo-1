...
#install.packages(c("tidyverse", "corrplot", "VIM", "ggplot2", "dplyr", "caret"))
...
2. R² Ajustado (Coeficiente de Determinación)
...
2. El R² ajustado nos indica qué tan bueno es el ajuste del modelo.
